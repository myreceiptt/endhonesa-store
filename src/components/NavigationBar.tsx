      ...
      <nav className="block w-full max-w-screen px-4 py-4 mx-auto bg-foreground font-[family-name:var(--font-geist-mono)]">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="lg:hidden">
            <button
              className="relative ml-auto h-8 max-h-[40px] w-8 max-w-[40px] select-none rounded-lg text-center align-middle text-sm font-medium uppercase text-background hover:bg-transparent focus:bg-transparent active:bg-transparent"
